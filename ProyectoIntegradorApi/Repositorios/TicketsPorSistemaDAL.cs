...
{
    public class TicketsPorSistemaDAL: ITicketsPorSistemaRepositorio
    {
        private readonly string _CadenaConexion;
        // Constructor
        public TicketsPorSistemaDAL(string pCadenaConexion)
        {
        ...
        public async Task<List<Ticket>> GetListadoTicketsPorSistema(int id)
        {
            ...
            using (SqlConnection con = new SqlConnection(_CadenaConexion))
            {
                ...
                cmd.Parameters.AddWithValue("@id_sistema", id);
